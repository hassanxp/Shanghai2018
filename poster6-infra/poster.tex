...
\includegraphics[width=0.9\linewidth]{figures/PfsIcsMhsHardwareConfigTarget}
}
...
\includegraphics[width=0.9\linewidth]{figures/DetailP2_Eth}
}
...
\begin{enumerate}
\item H.S. and CP acknowledge support by the National Science Foundation under Grant No 1636426 and support from the NAOJ.
\end{enumerate}
}
