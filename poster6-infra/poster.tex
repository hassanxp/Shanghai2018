...
\includegraphics[width=0.8\linewidth]{figures/PfsIcsMhsHardwareConfigTarget}
}
...
\headerbox{Core Switch Layout}{name=switches,column=1, span=2, below=infra}{

The detailed core switch configuration and ethernet connections to the host and NFS machines are shown below.
\includegraphics[width=0.8\linewidth]{figures/DetailP2_Eth}
}
...
\headerbox{Open Points}{name=plans,column=0,below=infra}{
...
\item iSCSI links are preferred over FC. It is felt that the former are more robust. This may introduce a performance penalty however.
\end{enumerate}
}
\end{poster}
