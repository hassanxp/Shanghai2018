...
%----------------------------------------------------------------------------------------
%
{\sf\bf PFS Computing Infrastructure at Subaru} % Poster title
...
The detailed core switch configuration and ethernet connections to the host and NFS machines for the current configuration are shown below. This will be updated in due course to cover 3 hosts and 2 NFS machines.

{ \hspace*{1cm}\includegraphics[width=0.7\linewidth]{DetailP2_Eth} }
}
...
\headerbox{Open Points and Risks}{name=points,column=2,below=infra}{
...
\item Risks include: possible failure of Host2 that can affect the DB related operations; the loss of the 100TB disk array and related data.
\end{enumerate}
...
{\tiny HS and CL acknowledge support by the National Science Foundation under Grant No 1636426 and support from the NAOJ. EK acknowledges support from the NAOJ.}
...
\headerbox{User Access}{name=users, column=0, span=2, below=switches, , bottomaligned=acknowledgements}{
