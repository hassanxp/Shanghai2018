...
\vspace{0.25cm}
{ \hspace*{1cm}\includegraphics[width=0.80\linewidth]{PfsIcsMhsHardwareConfigTarget} }
}
...
{ \hspace*{0.0cm}\includegraphics[width=0.8\linewidth]{DetailP2_Eth} }
}
...
\item Risks: At the present time the redundant storage machines are not in place and delays in installing these would pose problems with regards to recovery of operations.
\end{enumerate}
}
